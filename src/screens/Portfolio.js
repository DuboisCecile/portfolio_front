      ...
      <div className="page-content">
        ...
        <section id="motorhome" className="project">
          ...
          <div id="hover-motorhome">
            ...
            <div className="text-block">
              ...
              une application de gestion de commandes de camping&#8209;cars de
              la part de concessions, auprès de la branche française d'un
            ...
            <div className="text-block strong-italic">
              ...
              il y a en permanence de nombreuses vérifications croisées à faire
              &nbsp;!
            </div>
            <div className="text-block">
              ...
              L'application leur propose alors différentes gammes, qui
              contiennent chacune plusieurs modèles.
            </div>
            <img
              className="img-resp"
            ...
            <div className="text-block">
              ...
              accessoire isolé, un moteur plus puissant que le moteur standard,
              et en même temps ajouter un pack qui contient aussi un
              moteur&nbsp;!
            </div>
            <img
              className="img-resp"
            ...
            <div className="text-block">
              ...
              quelles marques (sur les quatre) cette concession vend-elle ?
              Quels sont ses prévisions de vente à l'année ?
            </div>
            <img
              className="img-resp"
        ...
        <section id="coho" className="project">
          ...
          <div id="hover-coho">
            ...
            <div className="text-block">
              Le boîtier Coho est un appareil conçu pour surveiller les chevaux
              au box. Prise de photos, de vidéos, alertes en cas d'ouverture de
              porte en dehors des heures autorisées ou si le cheval est couché
              depuis trop longtemps, ce boîtier et son application associée sont
              de précieux compagnons pour les propriétaires de chevaux.
            </div>
            <img
              className="img-resp"
            ...
            <div className="text-block">
              ...
              pathologies telles que les coliques, qui peuvent être léthales si
              un vétérinaire n'intervient pas au plus vite.
              <br />
              ...
              (portentiel signe de souffrance), s'il est resté longtemps couché
              (ce qui peut être anormal pour un animal toujours sur le
              qui-vive).
              <br />
            ...
            <div className="text-block">
              ...
              parfois aussi² habités par... des araignées qui s'amusent à
        ...
        <section id="portfolio" className="project">
          ...
          <div id="hover-portfolio">
            ...
            <div className="text-block">Porfolio</div>
            <div className="text-block strong-italic">A faire</div>
          </div>
        </section>
        <div className="divider" />
        <section id="others" className="project">
          ...
          <div id="hover-others">
            <div className="text-block">
              ...
              plusieurs projets, dont un à destination d'un client final.
              <br />
